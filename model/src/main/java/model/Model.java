...
public class Model extends Observable implements IModel {
	...
	/**
	 * Instantiates the all load level
	 * @return
	 * Loads all levels
	 */
	...
	/**
	 * Instantiates the load of the level
	 * @param id
	 * Loads the level
	 */
	public boolean loadLevel(int id){
		...
		try {
			...
			while(rawElements.next()){
				...
				} else if(rawElements.getString(2).equals("life-buble")) {
	...
	/**
	 * Instantiates if the next level is loaded
	 * @return
	...
	/**
	 * Instantiates the load safety level
	 * A set of elements like vWall, door, money, monster, lifeBubble, Hero, Direction ...
	 */
